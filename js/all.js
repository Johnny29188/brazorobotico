...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Página principal","1. INTRODUCCION","2. DESCRIPCION","3. FUNCIONALIDAD GENERAL","4. SEGURIDAD FISICA DEL ROBOT","Brazo Robotico","Datos del Programa en la Base de Datos","Norma ISO/TS 15066:2016 – Robots and robotic devices.  "],
    DREX_NODE_LINKS: ["index.htm","1__introduccion.htm","2__descripcion.htm","3__funcionalidad_general__.htm","4__seguridad_fisica_del_robot.htm","brazo_robotico.htm","datos_del_programa_en_la_base_de_datos.htm","norma_iso_ts_15066_2016___robots_and_robotic_devices___.htm"],
    DREX_NODE_CHILD_START: [1,5,5,5,7,8,8,8],
    DREX_NODE_CHILD_END: [5,5,5,7,8,8,8,8],
    DREX_MENU_TYPE: 2,
